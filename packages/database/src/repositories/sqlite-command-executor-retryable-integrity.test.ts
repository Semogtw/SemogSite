...
describe("command receipt retryable replay integrity", () => {
  it("fails closed when restored failure stores retryable outside 0 or 1", async () => {
    ...
    await expect(
      ...
      kind: "failed",
      replayed: true,
      receiptId: "receipt-invalid-retryable",
